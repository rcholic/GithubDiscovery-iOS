...
$(document).ready(function() {
  ...
  // smartDraw('https://github.com/RedBearLab/iOS/pull/12.diff')
  //replaced//
  bind();
  ...
  function bind() {
    $('#url-btn').click(function(e) {
      e.preventDefault();
      var url = 'https://github.com/RedBearLab/iOS/pull/12.diff'; //$url.val();
      smartDraw(url);
    });
  ...
  function draw(req) {
    ...
    var outputFormat = 'side-by-side'; // $outputFormat.val();
